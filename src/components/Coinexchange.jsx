...
function CoinExchange() {
  ...
  return (
    <div className="lg:mt-8 lg:w-1/2 h-64 max-sm:px-3 px-8 py-3 bg-white bg-opacity-30  shadow-sm transition ease-in-out border-black border-2 hover:ring-4 ring-black rounded-md">
      <p className="max-sm:text-lg text-xl font-semibold text-black">
        Exchange Currencies
      </p>
      {/* Sell section */}
      <div className="flex items-start justify-between m-4">
        <div className="w-1/2 flex items-center max-sm:gap-1 gap-3">
          <p className="text-black font-medium max-sm:text-sm">Sell</p>
          <div className="w-10/12 max-sm:h-10 h-12 flex rounded-md border ">
            <div className="w-full h-full items-center relative flex rounded-md bg-white text-black shadow-sm border-black border-2 hover:ring-2 ring-black">
              ...
              {isSellOpen && (
                <div className="max-sm:h-[95px] max-sm:w-[90px] w-[145px] h-[140px] absolute max-sm:top-6 top-9 right-0 z-10 mt-4 origin-top-right rounded-md border border-black bg-white shadow-lg overflow-y-scroll">
                  <div>
                    {Object.keys(exchangeData.rates || {}).map((coinName, index) =>{
                      ...
                      return(
                        <div
                          ...
                          className="block rounded-lg px-4 py-2 max-sm:text-xs text-base text-black no-underline hover:ring-2 ring-black  cursor-pointer"
                        >
                          {coinData.name}
                        </div>
                      );
        ...
        <div className="w-1/2 flex items-center justify-center">
          <input
          className='max-sm:h-10 h-12 w-10/12 max-sm:px-2 px-4 text-lg max-sm:text-xs text-gray-500 border-2 border-black rounded-lg font-medium focus:text-black cursor-pointer'
            type="number"
            placeholder="Amount"
            value={sellAmount}
      ...
      <div className="flex m-4 ">
        <div className="w-1/2 flex items-center max-sm:gap-1 gap-3">
          <p className="text-black font-medium max-sm:text-sm">Buy</p>
          <div className="w-10/12 max-sm:h-10 h-12 flex rounded-md border ">
            <div className="w-full h-full items-center relative flex rounded-md bg-white text-black shadow-sm border-black border-2 hover:ring-2 ring-black">
        ...
        <div className="w-1/2 flex items-center justify-center">
          <p className="text-blue-900 font-bold max-sm:text-sm">{exchangeResult}</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center">
        <button
          onClick={handleClick}
          className="text-black font-medium max-sm:px-4 max-sm:py-2 px-6 py-3 rounded-lg max-sm:text-sm border-black border-2 bg-green-400 hover:bg-green-800 cursor-pointer"
        >
          Exchange
        </button>
      </div>
