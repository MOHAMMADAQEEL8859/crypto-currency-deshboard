...
const Maindiv = () => {
  ...
  const mystyle = ` max-sm:text-xs px-4 py-2 max-lg:px-3 max-sm:rounded-lg rounded-xl bg-white  max-sm:p-1 max-sm:border border-black border-2 hover:ring-2 ring-black cursor-pointer text-black naie  backdrop-blur-md`;
  return (
    <div className="bg-white bg-opacity-40 lg:mt-8 mt-4 p-1 w-full h-96  shadow-sm transition ease-in-out border-black border-2 hover:ring-4 ring-black  rounded-md text-black">
      <div className="h-1/6 pt-2">
        <div className="max-sm:h-[68px] pb-1 flex">
          ...
          <div className="w-6/12 lg:w-5/12 h-full flex justify-evenly items-center lg:font-medium">
            <div
              className={`${mystyle} ${
                daysStyle["one"] ? "border-4 border-red-400 text-red-800" : ""
              }`}
            ...
            <div
              className={`${mystyle} ${
                daysStyle["week"] ? "border-4 border-red-400 text-red-800" : ""
              }`}
            ...
            <div
              className={`${mystyle} ${
                daysStyle["month"] ? "border-4 border-red-400 text-red-800" : ""
              }`}
            ...
            <div
              className={`${mystyle} ${
                daysStyle["six_months"] ? "border-4 border-red-400 text-red-800" : ""
              }`}
            ...
            <div
              className={`${mystyle} ${
                daysStyle["year"] ? "border-4 border-red-400 text-red-800" : ""
              }`} 
