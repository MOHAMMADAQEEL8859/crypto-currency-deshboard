...
const Portfolio = () => {
  ...
  return (
    <div className="bg-opacity-30 lg:mt-8 lg:w-1/2 flex max-sm:flex-col p-2 lg:h-64 h-fit text-black shadow-sm transition ease-in-out border-black border-2 hover:ring-4 ring-black  rounded-md bg-white ">
      <div className="w-3/12 max-sm:w-full max-sm:gap-1 flex flex-col items-start justify-between pt-2 pl-2 ">
        ...
        <p className="text-blue-800 align-middle max-sm:text-base text-xl">
          Total value{" "}
          <span className="text-blue-800 font-semibold">{totalVal}</span>
        </p>
      </div>
